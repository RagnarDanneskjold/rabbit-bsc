    ...
    IRewardDistributionRecipient
{
    ...
    uint256 public initreward = 25000 * 10**18;
    ...
    function getReward() public updateReward(msg.sender) checkhalve checkStart {
        ...
        if (reward > 0) {
            ...
            Morse.safeTransfer(DevAddress,reward.mul(10).div(100));
            Morse.safeTransfer(msg.sender, reward);
